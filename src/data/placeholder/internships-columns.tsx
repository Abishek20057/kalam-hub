...
import { Internship, ContentStatus } from "@/lib/types/cms";
...
function ActionsCell({ item }: { item: Internship }) {
  "use no memo";
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem asChild>
            <Link href={`/admin/content/internships/${item.id}`}>
...
export const columns: ColumnDef<Internship>[] = [
  ...
  },
  {
    accessorKey: "type",
    header: "Type",
    cell: ({ row }) => <Badge variant="category">{row.getValue("type")}</Badge>,
  },
  {
    accessorKey: "status",
    header: "Status",
